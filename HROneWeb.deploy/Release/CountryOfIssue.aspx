<%@ page language="C#" autoeventwireup="true" inherits="CountryOfIssue, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table border="0" width="100%" cellpadding="0" cellspacing="0" class="pm_section_title">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Country of Issue" />
                        </td>
                    </tr>
                </table>
                        ...
                        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_CountryCode" OnClick="ChangeOrder_Click" Text="Code" /></td>
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_CountryDesc" OnClick="ChangeOrder_Click" Text="Description" /></td>
                            </tr>
                            <tr id="AddPanel" runat="server">
                                ...
                                <td class="pm_list">
                                    <asp:TextBox ID="CountryCode" runat="server" /></td>
                                <td class="pm_list">
                                    <asp:TextBox ID="CountryDesc" runat="server" /></td>
                            </tr>
                                ...
                                <EditItemTemplate>
                                    <tr>
                                        <td class="pm_list" align="center">
                                            ...
                                            <input type="hidden" runat="server" id="CountryID" />
                                        </td>
                                        <td class="pm_list" align="center">
                                        ...
                                        <td class="pm_list">
                                            <asp:TextBox ID="CountryDesc" runat="server" />
                                        </td>
                                    </tr>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem, "CountryCode")%>
                                        </td>
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem, "CountryDesc")%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:DataList>
