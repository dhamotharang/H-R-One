<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Beneficiaries_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                    <tr>
                        <td>
                            <asp:Label runat="server" Text="Beneficiaries" />
                        </td>
                    </tr>
                </table>
