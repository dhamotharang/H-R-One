<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_TrainingEnroll_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_TrainingEnroll_List.ascx" TagName="Emp_TrainingEnroll_List"
    TagPrefix="uc2" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Training Record" />
                            </td>
                        </tr>
                    </table>
                    <uc2:Emp_TrainingEnroll_List ID="Emp_TrainingEnroll_List1" runat="server" />
                </td>
            </tr>
        </table>
