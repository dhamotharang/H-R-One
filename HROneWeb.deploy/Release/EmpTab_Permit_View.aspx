<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Permit_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_Permit_List.ascx" TagName="Emp_Permit_List"
    TagPrefix="uc2" %>
        ...
        <table width="100%" class="pm_section" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <uc2:Emp_Permit_List ID="Emp_Permit_List1" runat="server" />
                </td>
            </tr>
        </table>
