<%@ page language="C#" autoeventwireup="true" inherits="Report_Employee_Gender, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
		<tr>
			<td>
				<asp:Label ID="lblReportHeader" runat="server" Text="Employee Gender Report" />
			</td>
		</tr>
	</table>
        ...
        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
            ...
            <tr>
                <td class="pm_list_header" align="center">
                    <input type="checkbox" id="CheckAll" onclick="checkAll('<%=Repeater.ClientID %>','ItemSelect',this.checked);" />
                </td>
