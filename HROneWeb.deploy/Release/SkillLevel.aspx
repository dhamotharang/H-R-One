<%@ page language="C#" autoeventwireup="true" inherits="SkillLevel, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
                        ...
                        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_SkillLevelCode" OnClick="ChangeOrder_Click" Text="Code" /></td>
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_SkillLevelDesc" OnClick="ChangeOrder_Click" Text="Description" /></td>
                            </tr>
                            <tr id="AddPanel" runat="server">
                                ...
                                <td class="pm_list">
                                    <asp:TextBox ID="SkillLevelCode" runat="server" /></td>
                                <td class="pm_list">
                                    <asp:TextBox ID="SkillLevelDesc" runat="server" /></td>
                            </tr>
                                ...
                                <EditItemTemplate>
                                    <tr>
                                        <td class="pm_list" align="center">
                                            ...
                                            <input type="hidden" runat="server" id="SkillLevelID" />
                                        </td>
                                        <td class="pm_list" align="center">
                                        ...
                                        <td class="pm_list">
                                            <asp:TextBox ID="SkillLevelCode" runat="server" />
                                        </td>
                                        <td class="pm_list">
                                            <asp:TextBox ID="SkillLevelDesc" runat="server" />
                                        </td>
                                    </tr>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem,"SkillLevelCode")%>
                                        </td>
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem,"SkillLevelDesc")%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:DataList>
