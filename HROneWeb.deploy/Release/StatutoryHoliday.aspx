<%@ page language="C#" autoeventwireup="true" inherits="StatutoryHoliday, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Statutory Holiday Setup" />
                </td>
            </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Statutory Holiday Year" />: <asp:DropDownList runat="server" ID="YearSelect" AutoPostBack="true" OnSelectedIndexChanged="YearSelect_SelectedIndexChanged" />
        ...
        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
            ...
            <tr>
                ...
                <td align="left" class="pm_list_header">
                    <asp:LinkButton runat="server" ID="_StatutoryHolidayDate" OnClick="ChangeOrder_Click" Text="Date"/></td>
                <td align="left" class="pm_list_header">
                    <asp:LinkButton runat="server" ID="_StatutoryHolidayDesc" OnClick="ChangeOrder_Click" Text="Description"/></td>
            </tr>
            <tr id="AddPanel" runat="server">
                ...
                <td class="pm_list">
                    <uc1:WebDatePicker id="StatutoryHolidayDate" runat="server" />
                </td>
                    
                <td class="pm_list">
                    <asp:TextBox ID="StatutoryHolidayDesc" runat="server" /></td>
            </tr>
                ...
                <EditItemTemplate>
                    <tr>
                        <td class="pm_list" align="center">
                            ...
                            <input type="hidden" runat="server" id="StatutoryHolidayID" />
                        </td>
                        <td class="pm_list" align="center">
                        ...
                        <td class="pm_list">
                            <asp:TextBox ID="StatutoryHolidayDesc" runat="server" />
                        </td>
                    </tr>
                </EditItemTemplate>
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="pm_list">
                            <%#sbinding.getFValue(Container.DataItem,"StatutoryHolidayDate","yyyy-MM-dd")%>
                        </td>
                        <td class="pm_list">
                            <%#sbinding.getValue(Container.DataItem,"StatutoryHolidayDesc")%>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:DataList>
