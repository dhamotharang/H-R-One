<%@ page language="C#" autoeventwireup="true" inherits="Payroll_Group_List, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Payroll Group Setup" />
                </td>
            </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Payroll Group Search" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%" class="pm_section">
            <tr>
                ...
                <td class="pm_search">
                    <asp:TextBox runat="server" ID="PayGroupCode" />
                </td>
            </tr>
            <tr>
                <td class="pm_search_header">
                ...
                <td class="pm_search">
                    <asp:TextBox runat="server" ID="PayGroupDesc" />
                </td>
            </tr>
        </table>
        </ContentTemplate> 
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Payroll Group List" />
                </td>
            </tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" class="pm_button_section">
