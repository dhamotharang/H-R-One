<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_SkillSet_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_Qualification_List.ascx" TagName="Emp_Qualification_List"
    TagPrefix="uc2" %>
<%@ Register Src="~/controls/Emp_Skill_List.ascx" TagName="Emp_Skill_List" TagPrefix="uc3" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Qualifications" />
                            </td>
                        </tr>
                    </table>
                    <uc2:Emp_Qualification_List ID="Emp_Qualification_List1" runat="server" />
                    <br />
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Skills" />
                            </td>
                        </tr>
                    </table>
                    <uc3:Emp_Skill_List ID="Emp_Skill_List1" runat="server" />
                </td>
            </tr>
        </table>
