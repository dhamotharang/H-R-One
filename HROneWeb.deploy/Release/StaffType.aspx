<%@ page language="C#" autoeventwireup="true" inherits="StaffType, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table border="0" width="100%" cellpadding="0" cellspacing="0" class="pm_section_title">
                    <tr>
                        <td>
                            <asp:Label runat="server" Text="Staff Type" />
                        </td>
                    </tr>
                </table>
                        ...
                        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_StaffTypeCode" OnClick="ChangeOrder_Click" Text="Code" /></td>
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_StaffTypeDesc" OnClick="ChangeOrder_Click" Text="Description" /></td>
                            </tr>
                            <tr id="AddPanel" runat="server">
                                ...
                                <td class="pm_list">
                                    <asp:TextBox ID="StaffTypeCode" runat="server" /></td>
                                <td class="pm_list">
                                    <asp:TextBox ID="StaffTypeDesc" runat="server" /></td>
                            </tr>
                                ...
                                <EditItemTemplate>
                                    <tr>
                                        <td class="pm_list" align="center">
                                            ...
                                            <input type="hidden" runat="server" id="StaffTypeID" />
                                        </td>
                                        <td class="pm_list" align="center">
                                        ...
                                        <td class="pm_list">
                                            <asp:TextBox ID="StaffTypeCode" runat="server" />
                                        </td>
                                        <td class="pm_list">
                                            <asp:TextBox ID="StaffTypeDesc" runat="server" />
                                        </td>
                                    </tr>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem,"StaffTypeCode")%>
                                        </td>
                                        <td class="pm_list">
                                            <%#sbinding.getValue(Container.DataItem,"StaffTypeDesc")%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:DataList>
