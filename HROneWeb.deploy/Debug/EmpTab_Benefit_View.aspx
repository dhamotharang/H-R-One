<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Benefit_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_Benefit_List.ascx" TagName="Emp_Benefit_List" TagPrefix="uc2" %>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                    <tr>
                        <td>
                            <asp:Label runat="server" Text="Benefit" />
                        </td>
                    </tr>
                </table>
                <uc2:Emp_Benefit_List ID="Emp_Benefit_List1" runat="server" />
            </td>
        </tr>
    </table>
</asp:Content> 