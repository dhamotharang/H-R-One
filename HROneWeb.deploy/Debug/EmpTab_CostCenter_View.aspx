<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_CostCenter_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_CostCenter_List.ascx" TagName="Emp_CostCenter_List" TagPrefix="uc4" %>
        ...
        <table width="100%" class="pm_section">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <uc4:Emp_CostCenter_List ID="Emp_CostCenter_List1" runat="server" />
                    <br />
                </td>
            </tr>
        </table>
