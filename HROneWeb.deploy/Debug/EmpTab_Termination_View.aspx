<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Termination_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_FinalPayment_List.ascx" TagName="Emp_FinalPayment_List"
    TagPrefix="uc3" %>
<%@ Register Src="~/controls/Emp_Termination.ascx" TagName="Emp_Termination" TagPrefix="uc2" %>
            ...
            <tr>
                ...
                <td valign="top">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Back" runat="server" Text="- Back -" OnClick="Back_Click" UseSubmitBehavior="false"
                                    cssclass="button" />
                                <asp:Button ID="TerminateButton" runat="server" Text="Terminate" CssClass="button" />
                                <asp:Button ID="Delete" runat="server" Text="Undo" CssClass="button" OnClick="Delete_Click" />
                            </td>
                            <td align="right">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label Text="Termination Details" runat="server" />
                            </td>
                        </tr>
                    </table>
                    <uc2:Emp_Termination ID="Emp_Termination1" runat="server" />
                    <br />
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label Text="Final Payment Details" runat="server" />
                            </td>
                        </tr>
                    </table>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
        <ContentTemplate >
                    <uc3:Emp_FinalPayment_List ID="Emp_FinalPayment_List1" runat="server"/>
        </ContentTemplate>
        </asp:UpdatePanel>
                </td>
            </tr>
