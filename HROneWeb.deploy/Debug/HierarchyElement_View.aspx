<%@ page language="C#" autoeventwireup="true" inherits="HierarchyElement_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="View Business Hierarchy" />: 
                    <%=HElementCode.Text %>
                </td>
            </tr>
        </table>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" class="pm_field_section">
            ...
            <tr>
                ...
                <td class="pm_field">
                    <asp:Label ID="HElementCode" runat="Server" /></td>
                <td class="pm_field_header">
                    <asp:Label runat="server" Text="Description" />:</td>
                <td class="pm_field">
                    <asp:Label ID="HElementDesc" runat="Server" /></td>
            </tr>
        </table>
</asp:Content> 