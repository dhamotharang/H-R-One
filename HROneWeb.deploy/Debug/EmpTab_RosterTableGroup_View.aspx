<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_RosterTableGroup_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_RosterTableGroup_List.ascx" TagName="Emp_RosterTableGroup_List" TagPrefix="uc4" %>
        ...
        <table width="100%" class="pm_section">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <uc4:Emp_RosterTableGroup_List ID="Emp_RosterTableGroup_List1" runat="server" />
                </td>
            </tr>
        </table>
</asp:Content> 