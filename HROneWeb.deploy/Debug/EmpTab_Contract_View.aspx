<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Contract_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_ContractTerms_List.ascx" TagName="Emp_ContractTerms_List"
    TagPrefix="uc2" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Contracts" />
                            </td>
                        </tr>
                    </table>
                    <uc2:Emp_ContractTerms_List ID="Emp_ContractTerms_List1" runat="server" />
                </td>
            </tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" class="pm_button_section">
