<%@ page language="C#" autoeventwireup="true" inherits="UserGroup_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="View User Group" />:
                    <%=UserGroupName.Text %>
                </td>
            </tr>
        </table>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" class="pm_field_section">
            ...
            <tr>
                ...
                <td class="pm_field">
                    <asp:Label ID="UserGroupName" runat="Server" />
                </td>
            </tr>
            <tr>
                <td class="pm_field_header">
                ...
                <td class="pm_field">
                    <asp:Label ID="UserGroupDesc" runat="Server" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <table width="100%" cellspacing="0" class="pm_section">
            ...
            <tr>
                <td class="pm_field_title" colspan="2">
                    <asp:Label runat="server" Text="Function Permissions" />
                </td>
                ...
                <ItemTemplate>
                    <tr>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="Permission" runat="server" disabled="disabled"/>
                            <asp:Label runat="server" Text="Read" />
                        </td>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="WritePermission" runat="server" disabled="disabled"/>
            ...
            <asp:Panel ID="CostCenterPanel" runat="server" >
                <tr>
                    ...
                    <td class="pm_field_header" style="text-align: left">
                        <asp:Label ID="Label4" runat="server" Text="Cost Center" /></td>
                </tr>
                <asp:Repeater ID="CostCenterPermissions" runat="server" OnItemDataBound="ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            <td class="pm_field" style="white-space:nowrap;">
                                <input type="checkbox" id="Permission" runat="server" disabled="disabled"/>
                                <asp:Label ID="Label1" runat="server" Text="Read" />
                            </td>
                            <td class="pm_field" style="white-space:nowrap;">
                                <input type="checkbox" id="WritePermission" runat="server" disabled="disabled"/>
                                <asp:Label ID="Label2" runat="server" Text="Read/Write" />
                            </td>
                            <td class="pm_field">
                                <asp:Label ID="FunctionCode" runat="server" />
                                <asp:Label ID="Description" runat="server" />
            ...
            <asp:Panel ID="AttendancePanel" runat="server" >
                <tr>
                    ...
                    <td class="pm_field_header" style="text-align: left">
                        <asp:Label ID="Label5" runat="server" Text="Attendance" /></td>
                </tr>
            ...
            <tr>
                ...
                <td class="pm_field_header" style="text-align: left">
                    <asp:Label ID="Label3" runat="server" Text="Taxation" /></td>
            </tr>
            ...
            <asp:Panel ID="TrainingPanel" runat="server" >
                <tr>
                    ...
                    <td class="pm_field_header" style="text-align: left">
                        <asp:Label ID="Label6" runat="server" Text="Training" /></td>
                </tr>
            ...
            <asp:Panel ID="eChannelPanel" runat="server" >
                <tr>
                    ...
                    <td class="pm_field_header" style="text-align: left">
                        <asp:Label ID="Label13" runat="server" Text="e-channel" /></td>
                </tr>
            ...
            <tr>
                ...
                <td class="pm_field_header" style="text-align: left">
                    <asp:Label ID="Label7" runat="server" Text="Payroll & MPF Reports" /></td>
            </tr>
            <asp:Repeater ID="PayrollReportsPermissions" runat="server" OnItemDataBound="ItemDataBound">
                <ItemTemplate>
                    <tr>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="Permission" runat="server" disabled="disabled"/>
                            <asp:Label ID="Label8" runat="server" Text="Read" />
                        </td>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="WritePermission" runat="server" disabled="disabled"/>
                            <asp:Label ID="Label9" runat="server" Text="Read/Write" />
                        </td>
                        <td class="pm_field">
                            <asp:Label ID="FunctionCode" runat="server" />
                            <asp:Label ID="Description" runat="server" />
            ...
            <tr>
                ...
                <td class="pm_field_header" style="text-align: left">
                    <asp:Label ID="Label10" runat="server" Text="Taxation Reports" /></td>
            </tr>
            <asp:Repeater ID="TaxationReportsPermissions" runat="server" OnItemDataBound="ItemDataBound">
                <ItemTemplate>
                    <tr>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="Permission" runat="server" disabled="disabled"/>
                            <asp:Label ID="Label11" runat="server" Text="Read" />
                        </td>
                        <td class="pm_field" style="white-space:nowrap;">
                            <input type="checkbox" id="WritePermission" runat="server" disabled="disabled"/>
                            <asp:Label ID="Label12" runat="server" Text="Read/Write" />
                        </td>
                        <td class="pm_field">
                            <asp:Label ID="FunctionCode" runat="server" />
                            <asp:Label ID="Description" runat="server" />
