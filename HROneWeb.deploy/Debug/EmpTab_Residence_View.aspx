<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_Residence_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_PlaceOfResidence_List.ascx" TagName="Emp_PlaceOfResidence_List"
    TagPrefix="uc2" %>
        ...
        <table width="100%" class="pm_section" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <uc2:Emp_PlaceOfResidence_List ID="Emp_PlaceOfResidence_List1" runat="server" />
                </td>
            </tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" class="pm_button_section">
