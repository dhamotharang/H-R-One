<%@ page language="C#" autoeventwireup="true" inherits="Report_Leave_BalanceList, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Leave Balance List" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="pm_button_section">
            <tr>
                <td>
                    <asp:Button ID="Search" runat="server" Text="Search" CssClass="button" OnClick="Search_Click" UseSubmitBehavior="false"/>
        ...
        <table width="100%" class="pm_section">
            <tr>
                <td class="pm_field_header">
                    <asp:Label ID="lblAsOfDate" runat="server" Text="As Of Date" />
                </td> 
                <td class="pm_field">
            ...
            <tr>
                <td class="pm_field_header">
                    <asp:Label ID="Label2" runat="server" Text="Leave Type" />
                </td> 
                <td class="pm_field">
                    <input type="checkbox" onclick="checkAll('<%=LeaveTypeRepeater.ClientID %>','ItemSelect',this.checked);" checked="checked" />
                    <asp:Label ID="Label3" runat="server" Text="(Select All)"  /><br />
                    <asp:Repeater ID="LeaveTypeRepeater" runat="server" OnItemDataBound="LeaveTypeRepeater_ItemDataBound">
                        <ItemTemplate>
                            <asp:CheckBox ID="ItemSelect" runat="server" Checked="true" /><br />
                        </ItemTemplate>
                    </asp:Repeater>
                </td>
            </tr>
