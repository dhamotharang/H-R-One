<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_BankAccount_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_BankAccount_List.ascx" TagName="Emp_BankAccount_List"
    TagPrefix="uc2" %>
        ...
        <table width="100%" class="pm_section" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <uc2:Emp_BankAccount_List ID="Emp_BankAccount_List1" runat="server" />
                </td>
            </tr>
        </table>
</asp:Content> 