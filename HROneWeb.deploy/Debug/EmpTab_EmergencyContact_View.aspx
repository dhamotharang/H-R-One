<%@ page language="C#" autoeventwireup="true" inherits="EmpTab_EmergencyContact_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>

<%@ Register Src="~/controls/Emp_EmergencyContact_List.ascx" TagName="Emp_EmergencyContact_List"
    TagPrefix="uc3" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Emergency Contact" />
                            </td>
                        </tr>
                    </table>
                    <uc3:Emp_EmergencyContact_List ID="Emp_EmergencyContact_List1" runat="server"></uc3:Emp_EmergencyContact_List>
                </td>
            </tr>
        </table>
</asp:Content> 