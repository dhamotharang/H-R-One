<%@ page language="C#" autoeventwireup="true" inherits="CostCenter, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table border="0" width="100%" cellpadding="0" cellspacing="0" class="pm_section_title">
                    <tr>
                        <td>
                            <asp:Label runat="server" Text="Cost Center" />
                        </td>
                    </tr>
                </table>
                        ...
                        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td align="left" class="pm_list_header">
                                    <asp:LinkButton runat="server" ID="_CostCenterCode" OnClick="ChangeOrder_Click" Text="Code" /></td>
                                <td align="left" class="pm_list_header">
                            ...
                            <tr id="AddPanel" runat="server">
                                ...
                                <td class="pm_list">
                                    <asp:TextBox ID="CostCenterCode" runat="server" /></td>
                                <td class="pm_list">
                                    <asp:TextBox ID="CostCenterDesc" runat="server" /></td>
                            </tr>
                                ...
                                <EditItemTemplate>
                                    <tr>
                                        <td class="pm_list" align="center">
                                            ...
                                            <input type="hidden" runat="server" id="CostCenterID" />
                                        </td>
                                        <td class="pm_list" align="center">
                                        ...
                                        <td class="pm_list">
                                            <asp:TextBox ID="CostCenterCode" runat="server" />
                                        </td>
                                        <td class="pm_list">
                                            <asp:TextBox ID="CostCenterDesc" runat="server" />
                                        </td>
                                    </tr>
                                </EditItemTemplate>
                                <ItemTemplate>
