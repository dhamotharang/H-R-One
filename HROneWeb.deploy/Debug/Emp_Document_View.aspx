<%@ page language="C#" autoeventwireup="true" inherits="Emp_Document_View, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="View Document" />
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <tb:DetailToolBar id="toolBar" runat="server"
                     ...
                     CustomButton1_Name="Set as Profile Photo" 
                     OnCustomButton1_Click="SetAsProfilePhoto_Click" 
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" class="pm_field_section">
            ...
            <tr>
                ...
                <td class="pm_field" >
                    <asp:Label ID="DocumentTypeID" runat="server" />
                </td>
                <td class="pm_field_header" >
            ...
            <tr>
                ...
                <td class="pm_field">
                    <asp:Label ID="EmpDocumentDesc" runat="Server" />
                </td>
            </tr>
        </table>
</asp:Content> 