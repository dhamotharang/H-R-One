<%@ page language="C#" autoeventwireup="true" inherits="Report_Payroll_Summary_List, HROneWeb.deploy" masterpagefile="~/MainMasterPage.master" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
        <tr>
            <td>
                <asp:Label ID="lblReportHeader" Text="Payroll Summary Report" runat="server" />
            </td>
        </tr>
    </table>
    <br />
    <table width="100%" class="pm_section" runat="server"  visible="false" >
        <tr>
            <td colspan="2" class="pm_section_title">
                <asp:Label ID="Label3" Text="Parameter" runat="server" />
            </td>
        </tr>
        <tr>
