...
{
    public class GenericReportTaskFactory : TaskFactory
    {
        protected DatabaseConnection dbConn;
        protected EUser user;
        protected string ReportName;
        protected HROne.Common.GenericReportProcess reportProcess;
        protected string reportTemplateFileName;
        protected string ExportFormat;
        protected bool IsLocalize;
        protected string OutputFilenamePrefix;
        public GenericReportTaskFactory(DatabaseConnection dbConn, EUser user, string ReportName, HROne.Common.GenericReportProcess reportProcess, string reportTemplateFileName, string ExportFormat, string OutputFilenamePrefix, bool IsLocalize)
        {
