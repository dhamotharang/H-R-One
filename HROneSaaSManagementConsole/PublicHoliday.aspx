<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicHoliday.aspx.cs" Inherits="PublicHoliday" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Public Holiday Setup" />
                </td>
            </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Public Holiday Year" />: <asp:DropDownList runat="server" ID="YearSelect" AutoPostBack="true" OnSelectedIndexChanged="YearSelect_SelectedIndexChanged" />
        ...
        <table class="pm_section" width="100%">
            <tr>
                <td class="pm_search_header">
                    <asp:Label ID="Label3" runat="server" Text="Update Holiday Table by File" />:</td>
                <td class="pm_search">
