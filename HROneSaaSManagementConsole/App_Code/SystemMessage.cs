...
namespace HROne.Translation
{
    ...
    public static class PageErrorMessage
    {
        ...
        {
            get { return WebUtility.GetLocalizedStringByCode("ERROR_INVALID_START_DATE", "Invald start date"); }
        }

        public static string ERROR_INVALID_END_DATE
        {
            get { return WebUtility.GetLocalizedStringByCode("ERROR_INVALID_END_DATE", "Invald end date"); }
        }
