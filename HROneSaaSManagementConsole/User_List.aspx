<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_List.aspx.cs" Inherits="User_List" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="User Search" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%" class="pm_section">
            <tr>
                ...
                <td class="pm_search">
                    <asp:TextBox runat="server" ID="LoginID" /></td>
                <td class="pm_search_header">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="User List" />
                </td>
            </tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" class="pm_button_section">
        ...
        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
            ...
            <tr>
                ...
                <td align="left" class="pm_list_header">
                    <asp:LinkButton runat="server" ID="_LoginID" OnClick="ChangeOrder_Click" Text="User ID"/></td>
                <td align="left" class="pm_list_header">
                    <asp:LinkButton runat="server" ID="_UserName" OnClick="ChangeOrder_Click" Text="User Name"/></td>
                <td align="left" class="pm_list_header">
                    <asp:LinkButton runat="server" ID="_UserAccountStatus" OnClick="ChangeOrder_Click" Text="Status"/></td>
                <td align="left" class="pm_list_header">
            ...
            <asp:Repeater ID="Repeater" runat="server" OnItemDataBound="Repeater_ItemDataBound">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="pm_list">
                            <a href="<%#HROne.Common.WebUtility.URLwithEncryptQueryString(Session, "User_Edit.aspx?UserID=" + binding.getValue(Container.DataItem,"UserID"))%>">
