<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompanyAutopayFile_List.ascx.cs" Inherits="CompanyAutopayFile_List" %>
...
<table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td align="left" class="pm_list_header">
            <asp:LinkButton runat="server" ID="_CompanyAutopayFileSubmitDateTime" OnClick="ChangeOrder_Click" Text="Submit Date"></asp:LinkButton></td>
        <td align="left" class="pm_list_header" >
            <asp:LinkButton runat="server" ID="_CompanyAutopayFileConfirmDateTime" OnClick="ChangeOrder_Click" Text="Confirm Date"></asp:LinkButton></td>
        <td align="left" class="pm_list_header">
            <asp:LinkButton runat="server" ID="_CompanyAutopayFileConsolidateDateTime" OnClick="ChangeOrder_Click" Text="Consolidate Date"></asp:LinkButton></td>
    </tr>
