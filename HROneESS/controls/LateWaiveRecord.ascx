<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LateWaiveRecord.ascx.cs" Inherits="LateWaiveRecord" %>

<%@ Register Src="~/controls/WebDatePicker.ascx" TagName="WebDatePicker" TagPrefix="uc1" %>

<input type="hidden" id="EmpID" runat="server" />
<input type="hidden" id="AttendanceRecordID" runat="server" />
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="pm_field_section">
    ...
    <tr  >
        ...
        <td class="pm_field" style="background-color:White;" colspan="3">
            <asp:Label ID="RequestLateWaiveReason" runat="Server" />
        </td>
    </tr>
