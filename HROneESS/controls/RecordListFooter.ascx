<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecordListFooter.ascx.cs" Inherits="RecordListFooter" %>
...
<table width="100%" cellspacing="0" cellpadding="0" class="pm_list_pagenav">
    <tr>
        <td align="right">
            ...
            <span class="tabletitle"><asp:Label ID="lblRecordCount" runat="server" /></span> &nbsp;
