<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Emp_Request_EmpInfo.ascx.cs" Inherits="Emp_Request_EmpInfo" %>
        ...
        <td colspan="4" class="pm_field_title">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td  align="right">
                        <asp:Button ID="Cancel" runat="server" Text="Cancel" CssClass="button" OnClick="Cancel_Click" />
                    </td>
                </tr>
            </table>
        </td>
