<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_HitBaseProcess_ExportTemplate_List.aspx.cs"    Inherits="Payroll_HitBaseProcess_ExportTemplate_List" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Export Hit Rate Data Entry Template" />
                </td>
            </tr>
        </table>
...
<%--            <asp:PostBackTrigger ControlID="btnExport"  />--%>
        ...
        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
            ...
            <tr>
                ...
                <td align="left" class="pm_list_header" >
                    <asp:LinkButton runat="server" ID="_PaymentCode" OnClick="ChangeOrder_Click" Text="PaymentCode" /></td>
            </tr>
            <asp:Repeater ID="Repeater" runat="server" OnItemDataBound="Repeater_ItemDataBound">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="pm_list">
                            <asp:Label ID="empRPPaymentCode" runat="server" />
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
