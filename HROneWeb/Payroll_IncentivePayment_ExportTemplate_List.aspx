<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_IncentivePayment_ExportTemplate_List.aspx.cs"    Inherits="Payroll_IncentivePayment_ExportTemplate_List" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Export Incentive Payment Template" />
                </td>
            </tr>
        </table>
