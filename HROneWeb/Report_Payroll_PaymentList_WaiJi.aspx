<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Payroll_PaymentList_WaiJi.aspx.cs" Inherits="Report_Payroll_PaymentList_WaiJi" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
        <tr>
            <td>
                <asp:Label ID="lblReportHeader" Text="Payment Summary List (WaiJi)" runat="server" />
            </td>
        </tr>
    </table>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
        <tr>
            <td>
                <asp:Label ID="Label1" Text="Report Parameters" runat="server" />
            </td>
        </tr>
    </table>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
        <tr>
            <td>
                <asp:Label ID="Label2" Text="Employee Filter" runat="server" />
            </td>
        </tr>
    </table>
