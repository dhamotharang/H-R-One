<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attendance_RosterTable_Edit_AdvancedTemplate.ascx.cs" Inherits="HROne.UI.Scheduler.Attendance_RosterTable_Edit_AdvancedTemplate" %>
