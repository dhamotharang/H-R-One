<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Emp_LeaveApplication_List.ascx.cs"
    Inherits="Emp_LeaveApplication_List" %>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
        <td class="pm_search_header">
            ...
            <asp:Label ID="LblLeaveCode" runat="server" Text="Leave Code" />:
            <asp:DropDownList ID="LeaveCode" runat="server" AutoPostBack="true" OnSelectedIndexChanged="LeaveCode_SelectedIndexChanged"  />
