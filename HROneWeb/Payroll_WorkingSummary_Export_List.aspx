<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Payroll_WorkingSummary_Export_List.aspx.cs" Inherits="Payroll_WorkingSummary_Export_List"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
		<tr>
			<td>
				<asp:Label ID="Label1" runat="server" Text="Export Employee Working Summary" />
			</td>
		</tr>
	</table>
