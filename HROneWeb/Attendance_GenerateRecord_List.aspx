<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Attendance_GenerateRecord_List.aspx.cs" Inherits="Attendance_GenerateRecord_List"%>
...
<%-- End 0000004, Miranda, 2014-06-19 --%>
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
		<tr>
			<td>
				<asp:Label ID="Label1" runat="server" Text="Generate Attendance Record" />
			</td>
		</tr>
	</table>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" class="pm_list_pagenav">
            <tr>
                <td>
                    ...
                    <asp:CheckBox ID="NoTimeCardRecord" runat="server" Text="No time card records"  CssClass="pm_link_pagenav"/>
                </td>
                <td>
