<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_HitRateProcess_Generate_CND.aspx.cs"    Inherits="Payroll_HitRateProcess_Generate_CND" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Export Claims And Deduction Template for Hit-Rate Based Payment" />
                </td>
            </tr>
        </table>
        <br /><br />
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Select Batch" />
                </td>
            </tr>
            <tr visible="false">
                <td visible="false">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="pm_list" align="right">
                            <%#sbinding.getValue(Container.DataItem, "HitRate", "#.##0.00")%>
                        </td>
                        <td class="pm_list"></td>
                    </tr>
                </ItemTemplate>
