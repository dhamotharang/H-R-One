<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Payroll_PaySlip_DotMatrix_List.aspx.cs" Inherits="Report_Payroll_PaySlip_DotMatrix_List" MasterPageFile="~/MainMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
        <tr>
            <td>
                <asp:Label ID="lblReportHeader" Text="Pay Slip Report (Dot Matrix)" runat="server" />
            </td>
        </tr>
    </table>
    <br />
