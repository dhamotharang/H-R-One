<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Employee_TerminationList_List.aspx.cs" Inherits="Report_Employee_TerminationList" MasterPageFile="~/MainMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Employee Termination List" />
                </td>
            </tr>
        </table>
