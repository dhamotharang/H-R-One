<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpTab_WorkingExperience_View.aspx.cs"    Inherits="EmpTab_WorkingExperience_View" MasterPageFile="~/MainMasterPage.master"  %>

<%@ Register Src="~/controls/Emp_WorkingExperience_List.ascx" TagName="Emp_WorkingExperience_List"
    TagPrefix="uc2" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="Working Experience" />
                            </td>
                        </tr>
                    </table>
                    <uc2:Emp_WorkingExperience_List ID="Emp_WorkingExperience_List1" runat="server" />
                </td>
            </tr>
        </table>
</asp:Content> 