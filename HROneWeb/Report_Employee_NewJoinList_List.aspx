<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Employee_NewJoinList_List.aspx.cs" Inherits="Report_Employee_NewJoinList_List" MasterPageFile="~/MainMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="New Join Employee List" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <table width="100%" class="pm_section">
            <tr>
                <td class="pm_search_header">
                    <asp:Label ID="ProbationLastDateRangeHeader" runat="server" Text="Join Date" />:
                </td>
                <td class="pm_search" colspan="3">
                    <uc1:WebDatePicker id="EmpDateOfJoinFrom" runat="server" AutoPostBack="true" OnChanged="EmpDateOfJoin_Changed" CssClass="pm_required" />
                    -
                    <uc1:WebDatePicker id="EmpDateOfJoinTo" runat="server" AutoPostBack="true" OnChanged="EmpDateOfJoin_Changed" CssClass="pm_required" />
                 </td>
            </tr>
        </table> 
        </ContentTemplate >
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="Reset" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="EmpDateOfJoinFrom" EventName="Changed" />
            <asp:AsyncPostBackTrigger ControlID="EmpDateOfJoinTo" EventName="Changed" />
