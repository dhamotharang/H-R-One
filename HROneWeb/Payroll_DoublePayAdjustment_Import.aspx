<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_DoublePayAdjustment_Import.aspx.cs" Inherits="Payroll_DoublePayAdjustment_Import" MasterPageFile="~/MainMasterPage.master" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="ILabel1" Text="Import Double Pay Adjustment" runat="server" />
                </td>
            </tr>
        </table>
                    ...
                    <ItemTemplate>
                        <tr id="detailRow" runat="server">
                            <td class="pm_list" align="center">
                                <input type="hidden" runat="server" id="UploadDoublePayAdjustID" />
                            </td>
                            <td class="pm_list">
...
--%>                                <%#sbinding.getValue(Container.DataItem, "EmpNo") %>
                            ...
                            <td class="pm_list">
                                <%#sbinding.getFValue(Container.DataItem, "DoublePayAdjustEffDate", "yyyy-MM-dd")%>
                            </td>
                            <td class="pm_list" align="right">
                                <%#sbinding.getFValue(Container.DataItem, "SalesAchievementRate", "#,##0.00")%>
                            </td>
                            <td class="pm_list" ></td>
                        </tr>
                    </ItemTemplate>
