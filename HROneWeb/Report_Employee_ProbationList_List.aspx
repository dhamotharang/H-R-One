<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Employee_ProbationList_List.aspx.cs" Inherits="Report_Employee_ProbationList" MasterPageFile="~/MainMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Employee Probation List" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <table width="100%" class="pm_section">
            <tr>
                <td class="pm_search_header">
                    <asp:Label ID="ProbationLastDateRangeHeader" runat="server" Text="Probation Last Date" />:
                </td>
                <td class="pm_search" colspan="3">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" >
                    <ContentTemplate >
                        <uc1:WebDatePicker id="LastProbationDateFrom" runat="server" AutoPostBack="true" OnChanged="LastProbationDate_Changed" CssClass="pm_required" />
                        -
                        <uc1:WebDatePicker id="LastProbationDateTo" runat="server" AutoPostBack="true" OnChanged="LastProbationDate_Changed" CssClass="pm_required" />
                    </ContentTemplate >
                    </asp:UpdatePanel>
                 </td>
            </tr>
            <tr>
                <td class="pm_search_header">
                    <asp:Label ID="Label2" runat="server" Text="Probation Period" />:
                </td>
                <td class="pm_search" colspan="3">
                    <asp:TextBox ID="EmpProbaPeriod" runat="Server" Columns="1" MaxLength="1" AutoPostBack="true" OnTextChanged="LastProbationDate_Changed" />
                    <asp:DropDownList ID="EmpProbaUnit" runat="Server" AutoPostBack="true" OnSelectedIndexChanged="LastProbationDate_Changed" />
                 </td>
            </tr>
        </table> 
        <br />
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="Reset" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="LastProbationDateFrom" EventName="Changed" />
            <asp:AsyncPostBackTrigger ControlID="LastProbationDateTo" EventName="Changed" />
            <asp:AsyncPostBackTrigger ControlID="EmpProbaPeriod" EventName="TextChanged" />
            <asp:AsyncPostBackTrigger ControlID="EmpProbaUnit" EventName="SelectedIndexChanged" />
