<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_HitRateProcess_Import_History_View.aspx.cs"    Inherits="Payroll_HitRateProcess_Import_History_View" MasterPageFile="~/MainMasterPage.master" %>

<%@ Register Src="~/controls/RecordListFooter.ascx" TagName="RecordListFooter" TagPrefix="footer" %>
<%@ Register Src="~/controls/DetailToolBar.ascx" TagName="DetailToolBar" TagPrefix="tb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <input type="hidden" id="HitRateProcessImportBatchID" runat="server"  name="ID" />
        ...
        <table class="pm_section" width="100%">
            ...
            <tr>
                ...
                <td class="pm_field">
                    <asp:Label ID="HitRateProcessImportBatchDateTime" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="pm_field_header">
                ...
                <td class="pm_field">
                    <asp:Label ID="HitRateProcessImportBatchUploadedBy" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="pm_field_header">
                ...
                <td class="pm_field">
                    <asp:Label ID="HitRateProcessImportBatchRemark" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <ItemTemplate>
                    <tr>
                        <td class="pm_list" align="center" >
                            <input type="hidden" runat="server" id="HitRateProcessID" />
                        </td>
                        <td class="pm_list">
                            <%--
                        ...
                        <td class="pm_list" align="right">
                            <%#sbinding.getValue(Container.DataItem,"HitRate")%>
                        </td>
                        <td class="pm_list"></td>
                    </tr>
                </ItemTemplate>
