<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_IncentivePayment_Import.aspx.cs" Inherits="Payroll_IncentivePayment_Import" MasterPageFile="~/MainMasterPage.master" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="ILabel1" Text="Import Incentive Payment" runat="server" />
                </td>
            </tr>
        </table>
        ...
        <table class="pm_section" width="100%">
            <tr>
                ...
                <td class="pm_search">
                    <asp:FileUpload ID="IPImportFile" runat="server" Width="400" />
...
--%>                                <%#sbinding.getValue(Container.DataItem, "EmpNo") %>
                            ...
                            <td class="pm_list">
                                <%#sbinding.getFValue(Container.DataItem,"IPEffDate","yyyy-MM-dd")%>
                            </td>
