<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_CommissionAchievement_Generate_CND.aspx.cs"    Inherits="Payroll_CommissionAchievement_Generate_CND" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Export Claims And Deduction Template for Commission Achievement" />
                </td>
            </tr>
        </table>
