<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emp_ORSOPlan_Edit.aspx.cs"    Inherits="Emp_ORSOPlan_Edit" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" class="pm_field_section">
            ...
            <tr>
                ...
                <td class="pm_field" >
                    <uc1:WebDatePicker id="EmpORSOEffFr" runat="server" />
                </td>
                <td class="pm_field_header" >
                    <asp:Label Text="To" runat="server" />:</td>
                <td class="pm_field" >
                    <uc1:WebDatePicker id="EmpORSOEffTo" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="pm_field_header">
                ...
                <td class="pm_field" colspan="3" >
                    <asp:DropDownList ID="ORSOPlanID" runat="Server" /></td>
            </tr>
        </table>
</asp:Content> 