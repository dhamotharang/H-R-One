<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Employee_LeaveApplicationList.aspx.cs" Inherits="Report_Employee_LeaveApplicationList" MasterPageFile="~/MainMasterPage.master"  %>
...
<%-- End 0000004, Miranda, 2014-06-19 --%>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Employee Leave Application List" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%" class="pm_section">
            <tr>
                ...
                <td class="pm_field">
                    <%-- Start 0000004, Miranda, 2014-06-19 --%>
                    <uc1:WebDatePicker id="LeaveAppDateFr" runat="server" OnChanged="PayPeriod_Changed" AutoPostBack="true" /> -
                    <uc1:WebDatePicker id="LeaveAppDateTo" runat="server" OnChanged="PayPeriod_Changed" AutoPostBack="true" />
                    <%-- End 0000004, Miranda, 2014-06-19 --%>
                </td>
            </tr>
        </table>
