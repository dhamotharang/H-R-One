<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Attendance_RosterClient_View.aspx.cs" Inherits="Attendance_RosterClient_View" MasterPageFile="~/MainMasterPage.master"  %>
