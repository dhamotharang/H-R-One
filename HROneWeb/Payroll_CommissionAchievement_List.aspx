<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll_CommissionAchievement_List.aspx.cs"    Inherits="Payroll_CommissionAchievement_List" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Commission Achievement Process" />
                </td>
            </tr>
        </table>
