<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Payroll_CostAllocation_TrialRun_Adjustment_List.aspx.cs" Inherits="Payroll_CostAllocation_TrialRun_Adjustment_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Cost Allocation Trial Run Adjustment" />
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="panelPayPeriod" runat="server">
            ...
            <asp:Panel ID="panelCostAllocationAdjustmentDetail" runat="server">
                ...
                <table class="pm_section" width="100%">
                    <tr>
                        <td>
                            <asp:button ID="btnUndo" runat="server" Text="Undo" CssClass="button" OnClick="btnUndo_Click" />
                        </td>
                        <td align="right">
