<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Payroll_EEDAWList_List.aspx.cs" Inherits="Report_Payroll_EEDAWList_List" MasterPageFile="~/MainMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Employee Daily Average Wages Report" />
                </td>
            </tr>
        </table>

            <%-- Start 0000025, Miranda, 2014-03-22 --%>
            <uc2:EmployeeSearchControl id="EmployeeSearchControl1" runat="server" EmpStatusValue="A" >
            <%-- End 0000025, Miranda, 2014-03-22 --%>
            <AdditionElements >
                <tr>
...
--%>
                    <td class="pm_search_header">
                        <asp:Label ID="Label2" runat="server" Text="As Of Date" />:
                    </td>
                    <td class="pm_search">
                        <uc1:WebDatePicker id="AsOfDate" runat="server" CssClass="pm_required" />
                    </td>
                </tr>
            </AdditionElements>
