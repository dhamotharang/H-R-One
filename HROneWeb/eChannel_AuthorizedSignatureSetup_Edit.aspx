<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="eChannel_AuthorizedSignatureSetup_Edit.aspx.cs" Inherits="eChannel_AuthorizedSignatureSetup_Edit" %>
        ...
        <table border="0" width="100%" class="pm_list_section" cellspacing="0" cellpadding="1">
            ...
            <tr>
                ...
                <td align="left" class="pm_field">
                    <asp:CheckBox ID="chkPARAM_CODE_ECHANNEL_SIGNATURE_REQUIRED_FOR_AUTOPAY_FILE" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="left" class="pm_field_header" >
                ...
                <td align="left" class="pm_field">
                    <asp:CheckBox ID="chkPARAM_CODE_ECHANNEL_SIGNATURE_REQUIRED_FOR_MPF_FILE" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="left" class="pm_field_header" >
                ...
                <td align="left" class="pm_field">
                    <asp:TextBox ID="txtPARAM_CODE_ECHANNEL_NUM_SIGNATURE_REQUIRED" runat="server" />
                </td>
            </tr>
        </table>
