<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Payroll_LongServicePaymentSeverancePayment_List.aspx.cs" Inherits="Report_Payroll_LongServicePaymentSeverancePayment_List" MasterPageFile="~/MainMasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="lblReportHeader" runat="server" Text="Long Service Payment / Severance Payment Estimation Report" />
                </td>
            </tr>
        </table>
