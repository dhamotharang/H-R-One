<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpTab_CompensationLeaveEntitle_View.aspx.cs"    Inherits="EmpTab_CompensationLeaveEntitle_View" MasterPageFile="~/MainMasterPage.master"  %>

<%@ Register Src="~/controls/Emp_CompensationLeaveEntitle_List.ascx" TagName="Emp_CompensationLeaveEntitle_List"
    TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_section_title">
                        <tr>
                            <td>
                                <asp:Label Text="Compensation Leave Entitlement History" runat="server" />
                            </td>
                        </tr>
                    </table>
                    <uc4:Emp_CompensationLeaveEntitle_List ID="Emp_LeaveApplication_List1" runat="server" />
                </td>
            </tr>
        </table>
</asp:Content> 