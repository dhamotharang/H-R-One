<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Payroll_CostAllocation_ExportToExcel_Detail.aspx.cs" Inherits="Payroll_CostAllocation_ExportToExcel_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pm_page_title">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Cost Allocation Detail Export" />
                </td>
            </tr>
        </table>
        ...
        <table width="100%" class="pm_section">
            ...
            <tr>
                <td class="pm_field_header">
                    <asp:Label ID="Label7" runat="server" Text="Year/Month" />:
                </td>
                <td class="pm_field">
